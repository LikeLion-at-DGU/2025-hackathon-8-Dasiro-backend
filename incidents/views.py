...
class RecoveryIncidentViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        if lat and lng and radius:
            try:
                ...
                return self._api_response("error", "lat/lng/radius 값이 유효하지 않습니다", 400, {})
            ...
            queryset = queryset.annotate(distance_m=Value(None, output_field=FloatField()))
    ...
    def near(self, request):
        ...
        queryset = RecoveryIncident.objects.annotate(
